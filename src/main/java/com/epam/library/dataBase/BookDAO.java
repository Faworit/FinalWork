...
public interface BookDAO <T extends Book> extends CommonDAO {
    ...
    List<T> searchBook(List<String> argumentsLike, String requestToDB, int language) throws SQLException;
